...
namespace BioIK {
	...
	public class Orientation : BioObjective {
		...
		public override double ComputeLoss(double WPX, double WPY, double WPZ, double WRX, double WRY, double WRZ, double WRW, Model.Node node, double[] configuration, double rootWPX, double rootWPY, double rootWPZ, double rootWRX, double rootWRY, double rootWRZ, double rootWRW,bool compare, double alpha, double maxweight) {
            ...
            //Debug.Log("orientation loss: " + loss);
